...
import com.example.domainname_mvp.network.BASE_URL
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideISSService(retrofit: Retrofit): DomainService {
        return retrofit.create(DomainService::class.java)
    }
